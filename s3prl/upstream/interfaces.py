...
class Featurizer(nn.Module):
    ...
    def _weighted_sum(self, feature):
        ...
        # save_weight_path = "/home/haoy/da33_scratch/haoy/s3prl/s3prl/upstream/wav2vec2_hug/wavlmWeight/sid_5p.txt"
        # weight = norm_weights.unsqueeze(-1)
        # if weight[0][0] == weight[1][0] and weight[1][0] == 0.04:
        #     pass
        # else:
        #     fp = open(save_weight_path, 'a')
        #     for i in range(0, 25):
        #         fp.write(str(weight[i][0].item()) + '\n')
        #     exit()
